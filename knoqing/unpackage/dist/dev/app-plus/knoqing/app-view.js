...
var aL=_mz(z,'image',['class',14,'mode',1,'src',2],[],oH,hG,gg)
cs.pop()
_(lK,aL)
cs.pop()
_(cI,lK)
...
cs.push("./pages/index/index.vue.wxml:view:11:8")
var oV=_mz(z,'view',['bindtap',24,'class',1,'data-comkey',2,'data-eventid',3,'data-id',4,'hoverClass',5,'key',6],[],fS,oR,gg)
cs.push("./pages/index/index.vue.wxml:view:13:10")
var cW=_n('view')
_rz(z,cW,'class',31,fS,oR,gg)
cs.push("./pages/index/index.vue.wxml:image:14:12")
var oX=_mz(z,'image',['class',32,'mode',1,'src',2],[],fS,oR,gg)
cs.pop()
_(cW,oX)
...
var aZ=_n('view')
_rz(z,aZ,'class',36,fS,oR,gg)
var t1=_oz(z,37,fS,oR,gg)
_(aZ,t1)
cs.pop()
_(lY,aZ)
cs.pop()
